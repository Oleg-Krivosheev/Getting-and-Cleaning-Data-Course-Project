...
mdt     <- melt(selected.mean_std, id = c("subject","activity"))
tidy.dt <- dcast(mdt, subject+activity ~ variable, mean)

# Finaly, save tidy data set as a CSV to a file in IETF RFC4180 compatible format
